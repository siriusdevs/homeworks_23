...
TEST_DATA_WITH_WRONG_VALUES = (
    # Отрицательные значения - выдаем ошибку
    ((('Develop', [80, 80, 80, -20, 80]),
      ('Marketing', [80, 80, 80, -20, 80]),
      ('Sales', [80, 80, 80, -20, 80, 80]),
      ),
     ),
    # Передан пустой кортеж - выводим ошибку
    (((),)),
    # Передан кортеж без зарплаты - выдаем ошибку
    ((('Dev',),)),
    # Передан список зарплат, но не передано имя отдела
    ((([10, 20, 20, 80, 20],),
