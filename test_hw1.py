...
test_deps = (
    (
        {
        'Goggle': {'Larson': 200.0, 'Simon': 400.0, 'Vincent': 600.0},
        'Tyndex': {'Nikolay': 800.0, 'Alexey': 200.0, 'Helen': 550.0},
        'Spectacle': {'Thomas': 700.0, 'Van': 50.0},
        },
    ...
    (
        {
        'RED': {'Medic': 900.0, 'Sniper': 500.0, 'Demoman': 600.0},
        'BLU': {'Soldier': 1800.0, 'Heavy': 900.0, 'Scout': 1100.0},
        'GRN': {},
        'YLW': {'Engieneer': 300.0, 'Spy': 50.0},
        'GRY': {'Grey': 10000.0},
        },
    ...
    (
        {
        'Funi Sound': {'Keith': 1, 'Gigi': 2},
        'Bright Purple': {'David': 3, 'Mary': 4},
        'Mercs': {'Patrick': 2, 'Daniel': 2, 'Nancy': 2},
        'Crusher': {'Samuel': 5, 'Peter': 0},
        'Front Tier': {'John': 10, 'Steve': 4, 'Skittles': 1},
        'Classics': {'William': 5, 'Hector': 6, 'Garry': 0},
        'excluding': ('Bright Purple', 'Classics')
        },
    ...
    (
        {
        'Drivers': {'Dennis': 1000.0, 'Ivan': 200.0, 'Alex': 0},
        'Bodyguards': {'Andrew': 2000.0, 'Vladislav': 100.0, 'Vitaliy': 900.0},
        'Salesmen': {'Nikita': 6000.0, 'Peter': 2400.0, 'Michael': 500.0},
        'excluding': ('Salesmen')
        },
        ((('Bodyguards', 1000.0), ('Drivers', 400.0)), (('Drivers', 400.0), ('Bodyguards', 1000.0)))
    )
)
